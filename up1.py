...
settings = {
    ...
    "comment":"""♻𝕋𝕖𝕒𝕞🔘𝔹𝕠𝕥🔘ℍ𝕒𝕣𝕕𝕃𝕚𝕟𝕖♻:
╭════════╬☠╬════════╮
     📐॥᠒๊৩அัচદஅ📚 มาหาตีนจ้าาา
╰════════╬☠╬════════╯""",
    "userAgent": [
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "😈ຜู้คุມกาມlทW😈")
                    ...
                    try:
                        arr = []
                        owner = "ud32fc6154159e31972a02df230ff5690"
...
#==============================================================================#
                    ...
                    line.sendContact(to, "ud32fc6154159e31972a02df230ff5690")
                    line.sendContact(to, "ud32fc6154159e31972a02df230ff5690")
                    line.sendContact(to, "cb809b4416336a0cd70b21da339f2c6d6")                     
#==============================================================================#
...
#==============================================================================#
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                           line.sendText(g.mid,"☆~😈_ຜู้คุມกาມlทW_😈~❦ ")
                           line.sendText(g.mid,"☆~😈_ຜู้คุມกาມlทW_😈~❦ ")
                           line.sendText(g.mid,"☆~😈_ຜู้คุມกาມlทW_😈~❦ ")
                           line.sendText(g.mid,"☆~😈_ຜู้คุມกาມlทW_😈~❦ ")
                           line.sendText(g.mid,"☆~😈_ຜู้คุມกาມlทW_😈~❦ ")
                        ...
                        line.createGroup("♻𝕋𝕖𝕒𝕞🔘𝔹𝕠𝕥🔘ℍ𝕒𝕣𝕕𝕃𝕚𝕟𝕖♻",[key])
                        line.sendText(msg,to,"❋ทำการรัน สำเร็จ❋")
...
#==============================================================================#
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "♻𝕋𝕖𝕒𝕞🔘𝔹𝕠𝕥🔘ℍ𝕒𝕣𝕕𝕃𝕚𝕟𝕖♻\n❋ตั้งข้อความเมื่อมีคนแอด❋\n\n{}".format(str(spl)))
